...
func (c *engineClient) GetEnginesByCarsId(ctx context.Context, in *CarIdRequest, opts ...grpc.CallOption) (*EnginesResponse, error) {
	out := new(EnginesResponse)
	err := c.cc.Invoke(ctx, "/engines.Engine/GetEnginesByCarsId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEngineServer) GetEnginesByCarsId(context.Context, *CarIdRequest) (*EnginesResponse, error) {
...
func _Engine_GetEnginesByCarsId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CarIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EngineServer).GetEnginesByCarsId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engines.Engine/GetEnginesByCarsId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EngineServer).GetEnginesByCarsId(ctx, req.(*CarIdRequest))
	}
...
var Engine_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "engines.Engine",
	HandlerType: (*EngineServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetEnginesByCarsId",
			Handler:    _Engine_GetEnginesByCarsId_Handler,
		},
	},
